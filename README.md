...
**The conclusion is Random Forest could be the best model to solve this problem because it has the lowest Eout and it's the only model that could classify some of the points of class one correctly in addition to having 0.9 accuracy and 0.87 F1-score.**
